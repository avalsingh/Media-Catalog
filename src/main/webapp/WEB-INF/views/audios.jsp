			...
			<div class="row">
	          ...
	          <c:forEach var="media" items="${mediaList}">
	            ...
	            <div class="card h-100">
	              ...
	              <%-- <a href="#"><embed  controls autoplay = "0" autostart = "0" class="card-img-top" src="<c:url value= "http://localhost:8080/media-catalog/api/uploads/${media.fileName}"/>" alt=""   ></a> --%>
